  ...
  const faqData = [
    {
      ...
      answer: isSaasPage
        ? 'We offer Digital Marketing, SEO, and CRO — built to acquire high-intent users, improve rankings for revenue-driving keywords, and optimize your entire funnel for conversions.'
    ...
    {
      question: 'Do you handle landing pages and creatives?',
      answer:
