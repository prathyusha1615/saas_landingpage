  ...
  return (
    <section className="bg-black text-white px-6 py-16 md:p-[120px]">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-5xl 2xl:text-6xl font-semibold">{heading}</h2>
      </div>
        ...
        {services.map((service, idx) => (
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl p-[0.8px] bg-gradient-to-br from-[#080d18] via-[#080d18] to-[#FF9900]/50 opacity-0 group-hover:opacity-100 transition duration-300">
              <div className="w-full h-full rounded-[11px] bg-[#080d18]"></div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-5 text-[13px] leading-[22px] font-normal">
                {service.description}
              </p>
